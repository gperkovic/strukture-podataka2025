...
int main() {
    ...
    while (1) {
        ...
        if (choice == 1) {
            ...
            position_Directory found = find_directory(current_directory, name);
            if (found != NULL) {
            ...
            if (head_stack.next == NULL || head_stack.next->next == NULL) {
...
position_Directory pop(position_stack head_stack) {
    ...
    position_Directory dir = to_delete->directory;
